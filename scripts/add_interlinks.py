...
LINK_MAP = [
    ...
    ("SEO attribution tools", "/list/best-marketing-attribution-tools/", False, "P1"),
    ("marketing attribution tools", "/list/best-marketing-attribution-tools/", False, "P1"),
    ...
    ("AI content optimization tools", "/list/best-content-optimization-tools/", False, "P1"),
    ("content optimization tools", "/list/best-content-optimization-tools/", False, "P1"),
    ("all-in-one AI SEO platforms", "/list/best-ai-seo-tools/", False, "P1"),
    ("AI SEO platforms", "/list/best-ai-seo-tools/", False, "P1"),
    ...
    # ---- tool-vs-tool comparisons batch added 2026-06-26 ----
    ("SE Ranking vs Semrush", "/compare/se-ranking-vs-semrush/", False, "P2"),
    ("Ahrefs vs Moz", "/compare/ahrefs-vs-moz/", False, "P2"),
    ("Moz vs Semrush", "/compare/moz-vs-semrush/", False, "P2"),
    ("Semrush vs SpyFu", "/compare/semrush-vs-spyfu/", False, "P2"),
    ("Ahrefs vs Ubersuggest", "/compare/ahrefs-vs-ubersuggest/", False, "P2"),
    ("Mangools vs Semrush", "/compare/mangools-vs-semrush/", False, "P2"),
    ("Leadpages vs Unbounce", "/compare/leadpages-vs-unbounce/", False, "P2"),
    ...
    ("Meta ads", "/blogs/meta-ads-for-b2b-saas/", False, "P1"),
    ...
    ("ad fatigue", "/blogs/saas-ad-fatigue/", False, "P2"),
