...
def test_compare_bridge_alternative_page():
    """Alternative page source + /compare/ target → bridge near competitor mention."""
    body = (
    ...
    print("✓ Compare bridge: alternative source inserts bridge near competitor mention")
...
if __name__ == "__main__":
    tests = [
        ...
        test_compare_bridge_alternative_page,
