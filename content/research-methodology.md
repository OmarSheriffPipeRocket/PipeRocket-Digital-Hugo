...
If you ever see a PipeRocket list where our placement looks unearned, email <a href="mailto:editorial@piperocket.digital">editorial@piperocket.digital</a> with specifics. We'll investigate publicly and either move ourselves or remove the list.
...
If you spot a factual error on any PipeRocket list, a wrong rating, an outdated price, a misattributed quote, an agency we listed that shouldn't be there, or an agency we missed that should be, email <a href="mailto:editorial@piperocket.digital">editorial@piperocket.digital</a> with:
...
Every list under [`/list/`](/list/) follows the criteria above. The newest examples:
