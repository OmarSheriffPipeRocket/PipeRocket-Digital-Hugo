...
The page isn't the problem. A bottom-of-funnel page almost never ranks on its own merit. It ranks because the rest of your site gives Google a reason to trust it, and because the page itself matches exactly what the searcher wanted to see. This is the process I use to actually rank these pages, even on a young, low-authority SaaS domain.
...
This is the core mistake, and it's a structural one. BOFU and TOFU aren't two separate problems. They're one engine. TOFU-heavy sites pull traffic but book few demos; BOFU-only sites have the intent but never rank, because Google has no signal that you actually know the category. Organic search still drives 91.3% of SaaS traffic, so abandoning the supporting content that earns that visibility leaves your decision-stage pages with nothing behind them.
