...
A page might get 40 visitors a month and still be your best-converting URL on the site. Decision keywords are the heart of [ranking BoFu keywords for SaaS](/blogs/how-to-rank-bofu-keywords-saas/), and they deserve their own dedicated pages (comparison and pricing among them), not a paragraph buried in a blog.
...
The word alone can't always resolve who's behind it, which is the exact problem the [ICP intent scoring rubric](/blogs/how-to-score-saas-keywords-by-icp-intent/) is built to solve. Read the query, then sanity-check it against who your buyer actually is.
...
This is why [ICP](/glossary/what-is-icp/) belongs in the mapping exercise, not after it. A keyword that's perfect for the engineer is noise to the CEO.
...
This same tension shows up when you're choosing [search volume versus search intent](/blogs/how-to-choose-search-volume-vs-search-intent/), where the highest-volume version of a term and the highest-intent version are often two separate queries.
