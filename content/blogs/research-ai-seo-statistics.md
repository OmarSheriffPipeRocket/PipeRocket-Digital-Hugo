...
/\* ── Layout ── \*/
.page{display:grid;grid-template-columns:200px 1fr 280px;gap:32px;max-width:100%;margin:0;padding:2.5rem 24px 5rem;align-items:start}
.main{min-width:0}
.sidebar-left{position:sticky;top:24px}
.sidebar-right{position:sticky;top:24px;display:flex;flex-direction:column;gap:20px}
/\* ── TOC left ── \*/
.toc{padding:0}
.toc-title{font-size:12px;font-weight:700;text-transform:uppercase;letter-spacing:.07em;color:#888;margin-bottom:.75rem}
.toc a{display:block;font-size:14px;color:#2F269B;text-decoration:none;padding:5px 0 5px 12px;border-left:2px solid transparent;transition:all .15s;line-height:1.4}
.toc a:hover{border-left-color:#2F269B;color:#2F269B}
.toc a.active{border-left-color:#FF0025;color:#FF0025;font-weight:600}
/\* ── Related guides ── \*/
.related-link{display:flex;align-items:flex-start;gap:10px;padding:10px 0;border-bottom:1px solid #eee;text-decoration:none;transition:opacity .15s}
.related-link:last-child{border-bottom:none}
.related-link:hover{opacity:.75}
.related-arrow{color:#FF0025;font-size:15px;font-weight:700;flex-shrink:0;margin-top:2px}
.related-body{display:flex;flex-direction:column;gap:2px}
.related-body strong{font-size:13px;font-weight:700;color:#111;line-height:1.35}
.related-sub{font-size:12px;color:#888;line-height:1.4}
/\* ── Mobile TOC dropdown ── \*/
.toc-mobile{display:none;margin-bottom:1.5rem}
.toc-mobile summary{font-size:13px;font-weight:600;color:#2F269B;cursor:pointer;padding:10px 14px;background:#f0f2ff;border-radius:8px;border:1px solid #d0d4f5;list-style:none;display:flex;justify-content:space-between;align-items:center}
.toc-mobile summary::after{content:"▾";font-size:12px}
.toc-mobile[open] summary::after{content:"▴"}
.toc-mobile a{display:block;font-size:13px;color:#2F269B;text-decoration:none;padding:7px 14px;border-bottom:1px solid #eee}
.toc-mobile a:last-child{border-bottom:none}
.toc-mobile .toc-links{background:#fff;border:1px solid #d0d4f5;border-top:none;border-radius:0 0 8px 8px}
/\* ── Author card ── \*/
.author-card{border:1px solid #e8e8e8;border-radius:10px;padding:1.25rem 1.5rem;text-align:center}
.author-avatar{width:80px;height:80px;border-radius:50%;margin:0 auto .75rem;overflow:hidden;border:3px solid #2F269B}
.author-avatar img{width:100%;height:100%;object-fit:cover;display:block}
.author-name{font-size:16px;font-weight:700;color:#111;margin-bottom:.4rem}
.author-bio{font-size:13px;color:#666;line-height:1.6;margin-bottom:1rem}
.author-link{display:block;font-size:13px;font-weight:600;color:#FF0025;text-decoration:none;background:#fff5f5;border:1px solid #ffd0d0;border-radius:6px;padding:9px 10px}
.author-link:hover{background:#ffe8e8}
/\* ── CTA card ── \*/
.cta-card{background:#171539;border-radius:10px;padding:1.5rem;color:#fff}
.cta-card h4{font-size:18px;font-weight:700;line-height:1.3;margin-bottom:.6rem}
.cta-card p{font-size:13px;color:#a8a4cc;line-height:1.6;margin-bottom:1.25rem}
.cta-card a{display:block;background:#fff;color:#171539;font-size:14px;font-weight:700;text-align:center;padding:11px 12px;border-radius:6px;text-decoration:none}
.cta-card a:hover{background:#f0eeff}
/\* Mobile author/CTA \*/
.mobile-sidebar{display:none;flex-direction:column;gap:20px;margin-top:2.5rem}
/\* ── Typography ── \*/
.intro-txt{font-size:16px;line-height:1.8;margin-bottom:1.25rem;color:#222}
.kt{background:#f7f8fa;border-radius:10px;padding:1.25rem 1.5rem;margin-bottom:2.5rem;border:1px solid #e8e8e8}
.kt h3{font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:.07em;color:#888;margin-bottom:.75rem}
.kt ul{padding-left:1.2rem}
.kt li{font-size:14px;line-height:1.75;margin-bottom:.35rem;color:#222}
h2{font-size:21px;font-weight:700;margin:2.75rem 0 .5rem;padding-top:1.5rem;border-top:1px solid #eee;color:#111;scroll-margin-top:24px}
.sec-intro{font-size:15px;line-height:1.8;color:#555;margin-bottom:1.25rem}
/\* ── Stats list ── \*/
ul.stats{padding-left:0;margin-bottom:1rem;list-style:none}
ul.stats li{font-size:15px;line-height:1.8;margin-bottom:.65rem;color:#222;display:flex;align-items:flex-start;gap:8px}
ul.stats li.ext{padding-left:1.3rem;display:block;position:relative}
ul.stats li.ext::before{content:"• ";color:#2F269B;position:absolute;left:0}
.stat-text{flex:1;min-width:0}
.stat-text::before{content:"• ";color:#2F269B}
.copy-btn{flex-shrink:0;margin-top:6px;background:none;border:1px solid #ddd;border-radius:4px;padding:5px 9px;font-size:12px;color:#aaa;cursor:pointer;white-space:nowrap;transition:all .15s;min-height:32px}
.copy-btn:hover{border-color:#2F269B;color:#2F269B}
.copy-btn.copied{border-color:#22a06b;color:#22a06b}
/\* ── Image blocks ── \*/
.img-block{background:#f7f8fa;border-radius:10px;padding:1.5rem;margin:1.75rem 0;border:1px solid #e8e8e8;overflow:hidden}
.caption{font-size:12px;color:#aaa;text-align:center;margin-top:.85rem;font-style:italic}
.chart-wrap{position:relative;width:100%}
.legend{display:flex;flex-wrap:wrap;gap:14px;margin-top:.85rem;font-size:12px;color:#666}
.legend span{display:flex;align-items:center;gap:5px}
.sw{width:10px;height:10px;border-radius:2px;flex-shrink:0}
/\* ── Stat cards ── \*/
.two-stat{display:grid;grid-template-columns:1fr 1fr;gap:12px;margin:1.5rem 0}
.stat-card{background:#f7f8fa;border-radius:8px;padding:1.1rem 1.25rem;border:1px solid #e8e8e8}
.stat-card .num{font-size:28px;font-weight:700;line-height:1;margin-bottom:.3rem}
.stat-card .lbl{font-size:13px;color:#555;line-height:1.45}
.stat-card.blue .num{color:#2F269B}
.stat-card.red .num{color:#FF0025}
/\* ── VS cards ── \*/
.vs-wrap{display:grid;grid-template-columns:1fr 1fr;gap:16px;margin:1.5rem 0}
.vs-card{border-radius:8px;padding:1.1rem 1.25rem;border:1px solid #e8e8e8}
.vs-card.blue{background:#f0f2ff}
.vs-card.red{background:#fff2f3}
.vs-card .vs-label{font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:.05em;margin-bottom:.5rem}
.vs-card.blue .vs-label{color:#2F269B}
.vs-card.red .vs-label{color:#FF0025}
.vs-card .vs-row{display:flex;justify-content:space-between;font-size:13px;padding:4px 0;border-bottom:1px solid rgba(0,0,0,.06)}
.vs-card .vs-row:last-child{border-bottom:none}
.vs-card .vs-key{color:#555}
.vs-card .vs-val{font-weight:600;color:#111}
/\* ── Data table ── \*/
.table-scroll{overflow-x:auto;-webkit-overflow-scrolling:touch;margin:1.25rem 0}
.data-table{width:100%;min-width:420px;border-collapse:collapse;font-size:14px}
.data-table th{text-align:left;padding:9px 12px;font-size:12px;font-weight:600;color:#888;border-bottom:1px solid #eee;background:#f7f8fa;white-space:nowrap}
.data-table td{padding:9px 12px;border-bottom:1px solid #eee;color:#222;white-space:nowrap}
.data-table tr:last-child td{border-bottom:none}
/\* ── Bar chart ── \*/
.bar-wrap{margin:.5rem 0}
.brow{display:flex;align-items:center;gap:10px;margin-bottom:9px}
.blbl{width:90px;color:#666;text-align:right;flex-shrink:0;font-size:12px}
.btrack{flex:1;height:26px;background:#e8e8e8;border-radius:4px;overflow:hidden;min-width:0}
.bfill{height:100%;display:flex;align-items:center;padding-left:8px;font-size:12px;font-weight:600;border-radius:4px;white-space:nowrap}
/\* ── Misc ── \*/
hr.div{border:none;border-top:1px solid #eee;margin:2.5rem 0}
.note{font-size:13px;color:#888;border-top:1px solid #eee;padding-top:1.25rem;margin-top:2rem;line-height:1.7}
.ext-src{font-size:13px;color:#888}
.ext-src a{color:#888;text-decoration:underline}
/\* ── Traffic chart split layout ── \*/
.traffic-split{display:grid;grid-template-columns:1fr 1fr;gap:16px;align-items:center}
.traffic-stats div{margin-bottom:14px}
.traffic-stats div:last-child{margin-bottom:0}
@media(max-width:520px){
.traffic-split{grid-template-columns:1fr}
.traffic-split .chart-wrap{height:160px !important}
.traffic-stats{display:flex;gap:24px}
.traffic-stats div{margin-bottom:0}
}
/\* ── RESPONSIVE ── \*/
@media(max-width:960px){
.page{grid-template-columns:1fr 220px;gap:32px;padding:2rem 24px 4rem}
.sidebar-left{display:none}
.toc-mobile{display:block}
}
@media(max-width:700px){
.page{grid-template-columns:1fr;gap:0;padding:1.25rem 1rem 3rem}
.sidebar-left{display:none}
...
.two-stat{grid-template-columns:1fr 1fr}
.stat-card .num{font-size:22px}
.stat-card .lbl{font-size:12px}
.vs-wrap{grid-template-columns:1fr}
#c\_funnel{height:220px !important}
#c\_verticals{height:240px !important}
.blbl{width:72px;font-size:11px}
.bfill{font-size:11px;padding-left:6px}
.copy-btn{padding:6px 10px;font-size:12px}
.kt{padding:1rem 1.1rem}
.kt li{font-size:13px}
}
...
[Traffic & Volume](#s1)
[Lead Generation & Pipeline](#s2)
[Engagement & Behaviour](#s3)
[Funnel & Intent](#s4)
[SaaS Verticals](#s5)
...
if(height>18)ctx.fillText(val+'%',x,y+height/2);
ctx.restore();
});
});
}};
new Chart(document.getElementById('c\_traffic'),{
type:'doughnut',
data:{labels:['Organic','AI engines'],datasets:[{data:[91.3,8.7],backgroundColor:[pr,pa],borderWidth:0}]},
options:{responsive:true,maintainAspectRatio:false,cutout:'65%',plugins:{legend:{display:false},tooltip:{display:false}}},
plugins:[{id:'donutLabels',afterDraw(chart){
const ctx=chart.ctx,ds=chart.data.datasets[0],meta=chart.getDatasetMeta(0);
meta.data.forEach((arc,i)=>{
const a=arc.startAngle+(arc.endAngle-arc.startAngle)/2;
const r=(arc.outerRadius+arc.innerRadius)/2;
const x=arc.x+Math.cos(a)\*r,y=arc.y+Math.sin(a)\*r;
ctx.save();ctx.fillStyle='#fff';
ctx.font='bold 12px -apple-system,sans-serif';
ctx.textAlign='center';ctx.textBaseline='middle';
ctx.fillText(ds.data[i]+'%',x,y);ctx.restore();
});
}}]
});
new Chart(document.getElementById('c\_funnel'),{
type:'bar',plugins:[labelPlugin],
data:{labels:['Organic','AI traffic'],datasets:[
{label:'ToFu',data:[59,56],backgroundColor:pr},
{label:'BoFu',data:[41,44],backgroundColor:pa}
]},
options:{responsive:true,maintainAspectRatio:false,
plugins:{legend:{display:false},tooltip:{display:false}},
scales:{
x:{stacked:true,grid:{display:false},ticks:{color:'#333',font:{size:13,weight:'600'}}},
y:{stacked:true,max:100,grid:{color:gc},ticks:{color:tc,callback:v=>v+'%'}}
}
}
});
new Chart(document.getElementById('c\_verticals'),{
type:'bar',plugins:[labelPlugin],
data:{labels:['Cybersecurity','Procurement','Fintech'],datasets:[
{label:'Organic',data:[81,75,25],backgroundColor:pr},
{label:'AI',data:[20,54,20],backgroundColor:pa}
]},
options:{responsive:true,maintainAspectRatio:false,
plugins:{legend:{display:false},tooltip:{display:false}},
scales:{
x:{grid:{display:false},ticks:{color:'#333',font:{size:13,weight:'600'}}},
y:{max:100,grid:{color:gc},ticks:{color:tc,callback:v=>v+'%'}}
}
}
});
...
const plain=`${stat} - source: PipeRocket Digital (${BLOG\_URL})`;
const html=`${stat} - source: <a href="${BLOG\_URL}">PipeRocket Digital</a>`;
