...
category: "B2B PPC"
featuredImage: "/images/blog-covers/linkedin-buying-committee-saas.webp"
---

Most SaaS LinkedIn campaigns aim at one job title, usually the champion, and then leadership asks why the pipeline isn't moving. The person who clicks your ad is rarely the person who signs the contract. A modern B2B software purchase is a group decision, and if your targeting only reaches one seat at the table, the deal stalls in the rooms you never advertised to.
...
- **The champion** wants the problem solved and will push internally.
- **The economic buyer** wants proof it's worth the spend.
- **The end user** wants it to not make their day harder.
- **The blocker** (security, finance, IT) wants a reason to say no.

Aim at one and the other three form their opinion of you from silence. That's the gap this article closes.

![The four roles in a SaaS buying committee and what each one cares about](/images/blog-infographics/linkedin-buying-committee-saas-infographic-1.webp)
...
|---|---|---|
| Champion | Manager or senior IC who owns the problem | Show you solve their exact pain |
| Economic buyer | VP, Director, or CXO who owns the budget | Prove the outcome is worth the spend |
| Blocker / reviewer | Security, IT, finance, procurement | Remove the reason to say no |

Build one audience per job. Same account list, different targeting filters and different creative, because a VP and a security reviewer will never respond to the same message.
...
- **1:1** for must-win whale accounts. Target only the specific CXOs, VPs, and directors at that named company, with creative built for them by name and role.
- **1:Few** for a cluster of 10 to 20 similar companies that share the same committee shape and pain.
- **1:Many** to scale across a broad 1,000 to 5,000 company [ICP](/glossary/what-is-icp/) list, still filtered by seniority and function.

The tier decides how personal the creative gets. A whale account is worth a founder-led video that names their situation, while a 1:Many campaign runs role-based messaging that fits a whole segment.

![LinkedIn ABM tiers matched to account value, from 1:1 whale accounts to 1:Many ICP lists](/images/blog-infographics/linkedin-buying-committee-saas-infographic-2.webp)

### 1:1 only pays off with sales alignment
...
A tight audience matched to your budget beats a huge one every time, because a wide net on a small budget influences almost nobody. This is the difference between showing an ad to a committee enough times to register and spraying it once across a crowd that forgets you instantly. The metric that exposes this is audience penetration, the share of your target audience you actually reached at meaningful frequency.

{{< experience author="sabarish-chandrasekar" title="From under 2% penetration to nearly 20% with no extra budget" >}}
On one client's LinkedIn account our team found the classic failure: the audience was too broad for the budget, so they were reaching well under 2 of every 100 people who mattered. That's under 2% penetration, which is close to influencing no one. The ICP was right on paper (decision-makers, founders, senior roles), but the ads were showing to everyone from interns to managers who'd never buy.

We rebuilt a focused audience with strict job-function, seniority, and company-size filters, cutting it from hundreds of thousands down to thousands, added exclusions, and switched from Max Delivery to manual bidding. Penetration jumped from about 1.7% to 19.2%, a roughly 1000% increase, without spending an extra dollar. The attribution report later showed LinkedIn drove the awareness while [Google Ads](/glossary/what-is-google-ads/) closed the deals, which is exactly the committee dynamic you want to see.
{{< /experience >}}

The lesson for committee targeting is direct: filter hard by seniority and function so your frequency is high enough to matter, then let each committee role get its own tightly-scoped audience. A blocker who sees your ad once will forget you, while a blocker who sees the right message five times over a quarter recognizes your name when the champion brings you up.
...
Watch the deal size too. On a $20-a-month tool sold to freelancers, LinkedIn's high [CPC](/glossary/what-is-cost-per-click/) will bleed you dry, so committee targeting on LinkedIn is a high-ACV play, full stop. If your average deal doesn't justify the impression cost of reaching several roles per account, this channel isn't your first move.
...
### How many people are on a typical SaaS buying committee?

It varies with deal size, but most mid-market and enterprise SaaS purchases involve several distinct roles rather than one buyer. You'll usually find a champion who drives the problem, an economic buyer who owns the budget, one or more end users, and a reviewer from security, IT, or finance who can block the deal. The higher the ACV, the larger and more cross-functional the group tends to be, which is exactly why single-persona targeting underperforms.

### Should I target the whole committee in one LinkedIn audience or separate ones?

Separate audiences, using the same account list. A VP evaluating outcomes and a security reviewer looking for reasons to say no will never respond to the same message, so blending them into one audience means you under-serve both. Build one audience per committee role with its own seniority and function filters, then run creative tailored to what that role cares about. It costs more setup effort but it's the only way to influence a group with genuinely different concerns.

### How do I know LinkedIn Ads are working if the leads show up as direct or organic?

Measure lift instead of last-click attribution. After launching a committee campaign, watch whether direct traffic, branded searches, and total lead volume rise, and whether multiple people from target accounts start engaging. The clearest signal often comes from sales, when prospects mention seeing your ads on discovery calls. If your monthly lead count climbs and stuck deals start moving because a second stakeholder recognizes you, the channel is working even when the dashboard credits something else.
