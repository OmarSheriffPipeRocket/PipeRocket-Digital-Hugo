...
toc: true
wp_id: 2561
wp_link: "https://piperocket.digital/blogs/how-to-run-linkedin-ads-for-saas/"
...
### 1. Prospecting Ads: The Discovery Layer
...
- **1:Many**: This is where we scale. We upload a list of 1,000 to 5,000 companies that fit our Ideal Customer Profile (ICP).
...
- **Pipeline Deals**:  
  This is a favorite of mine. If a prospect becomes a lead and is currently in talks with your sales team, you shouldn’t leave them alone. I build an audience of companies currently in the pipeline and target the other decision-makers at those companies to keep our brand top-of-mind during their decision-making process.
- **Churned Customers**:  
  If a customer cancels, don’t let them go easily. You can run campaigns specifically for churned accounts offering them an incentive, like an Amazon voucher or a discount on a new contract, to make them come back.
- **Account Expansion**:  
...
When I looked inside their ad account, I found two massive [LinkedIn Ads mistakes](https://piperocket.digital/blogs/saas-linkedin-ads-mistakes-to-avoid/) that were effectively setting their budget on fire.
...
### How We Fixed It at PipeRocket Digital
...
### Step 2: Choose Between “Classic” and “Accelerate” Campaign Modes
...
- - **Single Image:** The standard feed ad.
  ...
  - **Video:** Essential for SaaS. Show the product in action.

- **Follower:** This ad appears on the side while scrolling nudging users to follow a page

- - **Document Ads:** This is a hidden gem. You can upload a PDF (like a whitepaper). Users can scroll through a preview in the feed and download it directly. It’s fantastic for lead gen.
  - **Conversation Ads:** These are the “Sponsored DMs” that appear in your inbox.

- **Event:** You can use this format while running events like webinars or podcasts.

- **Article and Newsletter:** These are also ads that appear on the side while scrolling promoting an article or a newsletter.

## What are Some Tips to Optimize my SaaS LinkedIn Ads Account?

I’ve [audited SaaS PPC accounts](https://piperocket.digital/blogs/how-to-conduct-saas-ppc-audit/) where thousands of dollars were wasted on two specific settings. Here is how to avoid those traps.
...
- **Always Exclude Small Companies:** If you target Enterprise, exclude companies with <500 employees.
- **Exclude Junior Roles:** Explicitly exclude “Entry Level,” “Training,” and “Unpaid” roles.
- **Exclude Irrelevant Industries:** Even if the job title matches, you might not want to target Non-Profits or Retail.
- **Exclude Competitors:** Upload a list of your competitors to ensure they aren’t viewing your ads.

### 3. Bidding Strategy: Manual vs. Max Delivery
...
## How to Measure Success with LinkedIn Ads for SaaS?
...
1. Did our **Direct Traffic** increase?
2. Did searches for our **Brand Name** on Google increase?
3. Did the overall **Lead Count** go up, even if LinkedIn isn’t claiming the credit?

Here is an example:

- Say you are only [running Google Ads](https://piperocket.digital/blogs/how-to-run-google-ads-for-saas/) and are getting up to 10 leads per month.
- Now you try out LinkedIn Ads on the side, and see the monthly leads reach 13-15 consistently.
- This means your LinkedIn Ads are working.
- On the other hand, if you are not seeing any meaningful improvements to your monthly leads generated, your LinkedIn Ads are not working.
...
If this sounds too much to handle, we at [PipeRocket Digital](https://piperocket.digital/saas-ppc/) can manage your LinkedIn ad strategy end-to-end, so that you can focus on other pressing issues. If you want to explore how we can help you with LinkedIn Ads - [reach out to us and let’s plan how to grow your pipeline](https://piperocket.digital/contact-us/).
