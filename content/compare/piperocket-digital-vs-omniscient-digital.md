...
short_answer:
  ...
  intro: >-
    Founders sizing up Omniscient Digital against PipeRocket land in our
    inbox more than almost any other comparison. The honest answer depends
    on a number most founders don't think about upfront: the stage of
    company you're running.
  callouts:
    - label: "PipeRocket fit"
      title: "Organic + paid under one roof"
      body: >-
        If you're Seed to early Series B and need organic SEO alongside
        paid under one retainer with pipeline reporting, **PipeRocket is
        the stronger fit**. $3,000 per month floor, SEO and PPC together,
        senior team on every account.
    - label: "Omniscient fit"
  ...
  columns:
    ...
    - heading: "Omniscient team"
      ...
      members:
        ...
        - { role: "Writer pool",               seniority: "Per account" }
        - { role: "Account lead",              seniority: "Senior" }
...
pricing:
  ...
  table:
    ...
    - { label: "Channels in base retainer", a: "SEO + PPC unified",       b: "SEO, content, GEO; no paid media" }
